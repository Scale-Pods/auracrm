            ...
            <div className="h-16 flex items-center justify-between px-6 border-b border-border">
                {(!sidebarCollapsed) && (
                    ...
                    >
                        ...
                        <span className="bg-clip-text text-transparent bg-accent-gradient">AuraCRM</span>
                    </motion.div>
                )}
                {sidebarCollapsed && (
                    ...
                    return (
                        <Link
                            ...
                            className={cn(
                                ...
                                isActive ? "text-text-primary" : "text-text-secondary hover:text-text-primary hover:bg-bg-elevated/50"
                            )}
                        >
                            <item.icon className={cn("flex-shrink-0 w-5 h-5", isActive ? "text-brand" : "")} />
